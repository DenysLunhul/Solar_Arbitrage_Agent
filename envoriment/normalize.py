...
# log1p first to compress heavy right tail, then StandardScaler for mean=0/std=1
LOG_THEN_STANDARD_COLS = [
    'DAM_Price',
]

# StandardScaler (supports negative values, e.g. temperature)
STANDARD_COLS = [
    'Load',
    'Temperature_2m',
    'Shortwave_radiation',
...
# MinMaxScaler [0,1] — zero is meaningful (no sun, no outage)
MINMAX_COLS = [
...
# Already in the right range for the network: sin/cos in [-1,1], Grid in {0,1}
PASSTHROUGH_COLS = [
    'Hour_sin', 'Hour_cos',
    'Day_sin', 'Day_cos',
